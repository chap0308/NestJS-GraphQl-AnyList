...
export class ListItemResolver {
  ...
  createListItem(
    ...
    //! pueden pedir el usuario para validarlo, @CurrentUser() user: User
    //? esto es para validar que el usuario es dueño de la lista en la que quiere insertar, es decir, user.lists.includes(createListItemInput.listId)
  ): Promise<ListItem> {
